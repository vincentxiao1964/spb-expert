    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('OPEN', 'Open'), ('CLOSED', 'Closed'), ('HIDDEN', 'Hidden (Moderated)')], default='OPEN', max_length=20, verbose_name='Status')),
                ('is_pinned', models.BooleanField(default=False, verbose_name='Is Pinned')),
                ('last_reply_at', models.DateTimeField(auto_now_add=True, verbose_name='Last Reply At')),
